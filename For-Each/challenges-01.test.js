...
const greeting = (word) => {
  // Solution code here...
  return greeting.toUpperCase(word)
}
console.log(greeting('patrice'));// this does not run, need help
...
callback();
 ...
 speaker('patrice', callback); //not sure if this works neither becasue the first .toUppercase example did not work.
...
const addNumbers = (num, arr, times, callback) => {
  let num = 1;
  let arr = [0]
  //do not know how to do the third 
  callback();
...
const removeOne = (num, arr) => {
  // Solution code here...
  let arr = [1,2,3]
  if(num = 2) { // not sure how to do the division by 3 and have a remainder of 2. and what the heck is modulo operation
  array.pop();
  }
}
